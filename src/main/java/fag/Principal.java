...
public class Principal {
	...
	public static void questao1_Scanner(Scanner scan) {
		...
		System.out.println("Entre com o seu nome e a sua idade");
	...
	public static void questao4_If(Scanner scan) {
		...
		else if(nota>=4 && nota<7) {System.out.println("Você está em RECUPERAÇÃO. Estude mais!");}
	...
	public static long calcularFatorial(int n) {
		...
		return cont; // Remova esta linha e implemente a lógica
	}
}